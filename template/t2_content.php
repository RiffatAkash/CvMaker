...
<div class="row">
    <div class="col-md-offset-8 col-md-4">
        <div class="panel-body" align="center">
            <button type="submit" name="btn" class="btn btn-outline btn-primary  " style="width: 100px" onclick="printContent('print')"><i class="fa fa-print"></i> Print</button>
                    ...
                    <div style="margin-left: 20px; margin-right: 20px">
                        <div class="col-sm-12">
                            <div class="col-sm-offset-3 col-sm-6">
                                <h4 align="center" ><strong>Curriculum Vitae</strong></h4>
                                <h4 align="center"><strong>Of</strong></h4>
                                <h4 align="center"><strong><?php echo $row['first_name'].$row['last_name'];?></strong></h4>
                                <h4 align="center"><strong>Address :  <?php echo $row['address']?></strong></h4>
                                <h4 align="center"><strong>Contact: <?php echo $row['phone']?></strong></h4>
                                <h4 align="center"><strong>Email:<?php echo $row['email']?></strong></h4>
                            </div>
                            <div class="col-sm-3">
                                <img src="../<?php echo $row['photo'];?>" width="160px" height="160px"><br><br><br>
                            </div></div>
                        <br><br>
                        <div >
